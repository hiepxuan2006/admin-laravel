...
@section('content')
    ...
    <div class="content-wrapper">
        @include('partials.content_header', ['name' => 'Role', 'key' => 'AddRole'])

        <!-- Main content -->
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <form class="col-sm-12" action="{{ route('role.store') }}" method="POST"
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control @error('display_name') is-invalid @enderror" name="display_name"
                                    placeholder="nhập mô tả vai trò">{{ old('display_name') }}</textarea>
                                @error('display_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
